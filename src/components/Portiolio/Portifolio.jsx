...
const projects = [
  {
    ...
    description:
      "Interactive Kindergarten Finder UI built with React and Tailwind",
  ...
  },
  {
    title: "Movie Website",
    description:
      "Modern and interactive Movie web site UI built with React.js.",
  ...
  },
  {
    title: "SEOM Project",
    description:
      "Sanitary-Epidemiological Safety Center  UI built with React.js.",
...
const Portifolio = () => {
  ...
  return (
    ...
    >
      <div className="container w-full  flex flex-col justify-center items-center py-12 px-4 sm:px-6 gap-3">
        {/* Section Header */}
        <div className="text-center max-w-3xl">
          ...
          <p className="text-gray-300 dark:text-gray-700 text-sm sm:text-base">
            Here are some of my recent projects. You can swipe, use arrows, or
            watch it autoplay.
          </p>
        </div>
            ...
            {projects.map((project, index) => (
              <SwiperSlide key={index}>
                <div className="bg-gray-900 dark:bg-gray-100 transition-all duration-700 border border-gray-700 dark:border-gray-300 rounded-lg p-4   flex flex-col gap-1 hover:border-green-500 cursor-pointer shadow-lg hover:shadow-2xl">
                  ...
                  <p className="text-sm sm:text-[15px] text-gray-300 dark:text-gray-700">
                    {project.description}
                  </p>
                  <button
                    onClick={() => window.open(project.link, "_blank")}
                    className="border-2 border-green-500 text-white px-2 py-2 w-full sm:w-[150px] rounded-md cursor-pointer hover:bg-green-500 dark:text-black dark:hover:bg-green-600 transition-colors duration-300 flex items-center justify-center gap-2 mt-2"
                  >
