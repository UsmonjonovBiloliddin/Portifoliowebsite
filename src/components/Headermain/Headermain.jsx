...
export default function Hero() {
  return (
    <div className="w-full max-h-screen bg-gray-900 dark:bg-white text-white dark:text-black ">
      <div className="container  min-h-[635px] w-full flex flex-col md:flex-row items-center justify-center p-6 md:p-12 gap-8 md:gap-16">
        {/* Text */}
        <div className="flex-1 text-center md:text-left space-y-6">
          ...
          <h2 className="text-[20px] sm:text-xl md:text-2xl font-semibold text-gray-300 dark:text-gray-700">
            <Typewriter
              words={[
                "I create dynamic, responsive web apps and love bringing ideas to life in the browser.",
              ]}
              cursor
              cursorStyle="|"
              typeSpeed={70}
