...
const skills = [
  ...
  {
    name: "GitHub",
    icon: <SiGithub className="text-gray-900 dark:text-gray-100" />,
  },
  { name: "Netlify", icon: <SiNetlify className="text-teal-400" /> },
  {
    name: "Vercel",
    icon: <SiVercel className="text-gray-900 dark:text-gray-100" />,
  },
  ...
  return (
    <div
      ...
      className="
                 ...
                 transition-colors "
    >
      <div className="container py-15 w-full flex flex-col items-center justify-center ">
